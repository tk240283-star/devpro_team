// グラフのインスタンスを保持する変数（ボタンを複数回押した時の重複描画を防ぐため）
let myChartInstance = null;

window.onload = () => {
    // ページの読み込み完了後にイベントリスナーを登録

    // ▼ ボタンがクリックされた時に処理を開始 ▼
    document.getElementById('load-btn').addEventListener('click', () => {
        
        // 読み込み中のメッセージを表示
        document.getElementById('status-msg').innerHTML = "データを読み込んでいます...";
        document.getElementById('daily-avg').innerHTML = "計算中...";
